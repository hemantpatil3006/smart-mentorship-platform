    ...
    <div className="h-[100dvh] bg-slate-950 text-slate-200 font-sans flex flex-col overflow-hidden">
      ...
      <nav className="h-14 sm:h-16 bg-slate-900/80 backdrop-blur-md border-b border-white/10 px-3 sm:px-6 flex justify-between items-center z-50 shrink-0">
        <div className="flex items-center gap-2 sm:gap-4">
          <Link href="/dashboard" className="text-slate-400 hover:text-white transition-colors p-1.5 sm:p-2 hover:bg-white/5 rounded-lg flex items-center gap-1.5 sm:gap-2 shrink-0">
          ...
          <div className="min-w-0">
            <h1 className="text-sm sm:text-lg font-bold text-white flex items-center gap-1.5 sm:gap-2 truncate">
              <span className="truncate">Mentorship Room</span>
